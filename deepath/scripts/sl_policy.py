...
def train():
    ...
    import os
    print('The python is path is', os.environ.get("PYTHONPATH"))
    ...
    with tf.Session() as sess:
        ...
        for episode in range(episodes):
            ...
            env.append_task_relations(train_data[episode % num_samples])
        ...
        oracle.persist_BFS(dataPath + 'tasks/' + relation + '/')
        print('Model saved')
